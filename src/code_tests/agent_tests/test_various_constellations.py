...
DEFAULT_DATA_GEN_FILE: str = 'data_generation/jssp/fjssp_config_job3_task4_tools0.yaml'

DEFAULT_TRAINING_FILE: str = 'training/dqn/fjssp_config_job3_task4_tools0.yaml'
